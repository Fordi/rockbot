...
bool game::test_teleport(classPlayer *test_player) {
    ...
    for (j=0; j<STAGE_MAX_LINKS; j++) {
        ...
        if (stage_data.links[j].id_map_origin != -1) {
            ...
            if ((stage_data.links[j].id_map_origin == currentMap && stage_data.links[j].pos_origin.x != 0xff /* was: -1 */)) {
            ...
            } else if (stage_data.links[j].id_map_destiny == currentMap && stage_data.links[j].bidirecional == true && stage_data.links[j].pos_destiny.x != 0xff /* was: -1 */) {
